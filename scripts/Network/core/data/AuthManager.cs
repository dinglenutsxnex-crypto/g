...
namespace Network.core.data
{
	public class AuthManager
	{
		...
		{
			KeyChainBinding.SetKeyChainData(ProjectSettings.GetSetting("application/config/name").AsString(), id);
		}
		...
		{
			login = string.Empty;
			KeyChainBinding.SetKeyChainData(ProjectSettings.GetSetting("application/config/name").AsString(), string.Empty);
		}
	}
}
