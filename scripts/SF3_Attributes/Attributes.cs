	...
	public class Attributes : ICloneable
	{
		public class SortAttributeComparer : IComparer<AttributeType>
		{
			private readonly Dictionary<AttributeType, int> _atributeNamesForSorted = new Dictionary<AttributeType, int>
			{
				...
				{ AttributeType.WeaponDamage, 1 },
				{ AttributeType.BodyDefense, 2 },
				{ AttributeType.CriticalChance, 3 },
				{ AttributeType.HeadDefense, 4 },
				{ AttributeType.UnarmedDamage, 5 },
				{ AttributeType.RangedDamage, 6 },
				{ AttributeType.MagicPower, 7 },
				{ AttributeType.Cooldown, 8 }
			};
		...
		public float GetAttribute(AttributeType attribKey)
		{
			...
			GD.PushWarning(string.Format("Attribute with name {0} is not exist", attribKey));
			return 0f;
		}
