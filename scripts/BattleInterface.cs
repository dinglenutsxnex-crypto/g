...
public sealed class BattleInterface : ExtentionBehaviour, ISceneInitializationObject
{
	...
	[Export]
	private Label _nickNameFullLable;
	...
	public void DisposeObject(Node obj)
	{
		if (obj != null)
		{
	...
	private void InitDebug(params Model[] models)
	{
		foreach (Model model in models)
		{
			...
			// TODO: port TweenPosition (NGUI → Godot Tween)
			...
			if (module != null)
			{
				module.GetComponent<ModelDebugInfo>().Init(model);
			}
		}
	}
	...
	{
		// TODO: port NGUITools.AddChild / TweenPosition to Godot
	}
