...
public class NetworkBalancerManager
{
	...
	public BalancerItem getBalancerItem()
	{
		if (balancerSettings == null)
		{
			GD.PrintErr("Error: Calling getBalancerItem before balancer was downloaded");
			return null;
		}
	...
	public NetworkSettings.ConfigVersion getConfigVersion()
	{
		if (balancerSettings == null)
		{
			GD.PrintErr("Error: Calling getConfigVersion before balancer was downloaded");
			return null;
		}
	...
	public string getConfigURL()
	{
		if (balancerSettings == null)
		{
			GD.PrintErr("Error: Calling getConfigURL before balancer was downloaded");
			return null;
		}
	...
	public string GetBalancerUrl()
	{
		...
		{
			string @string = (string)GD.Load("user://current_server");
