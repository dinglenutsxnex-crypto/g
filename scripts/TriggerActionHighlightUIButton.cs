...
internal class TriggerActionHighlightButton : TriggerActionQuest
{
	...
	private string _AnimationPlayer;
	public TriggerActionHighlightButton(Node yamlNode)
		: base(EActionType.HIGHLIGHT_UI_BUTTON, yamlNode, false)
	{
		...
		TryGetString(out _AnimationPlayer, "AnimationPlayer", string.Empty, string.Empty, null, false);
	...
	protected override void ApplyAction(object modelData)
	{
		...
		TutorialManager.Instance.ShowPanel(new TutorialManager.OpenTutorialCallData(_pannelType, _description, new string[0], _AnimationPlayer, _offset));
