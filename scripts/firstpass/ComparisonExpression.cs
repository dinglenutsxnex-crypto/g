...
public class ComparisonExpression
{
    ...
    public static ComparisonType GetTypeFromString(string name)
    {
        switch (name)
        {
            case "Equal": return ComparisonType.COMPARISON_EQUAL;
            case "Greater": return ComparisonType.COMPARISON_GREATER;
            case "GreaterEqual": return ComparisonType.COMPARISON_GREATER_EQUAL;
            case "Less": return ComparisonType.COMPARISON_LESS;
            case "LessEqual": return ComparisonType.COMPARISON_LESS_EQUAL;
            default: return ComparisonType.COMPARISON_NONE;
        }
    }
}
