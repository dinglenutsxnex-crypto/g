...
public class SF3UiLogger
{
	...
	{
		{ SubType.ButtonClick, "button_click" },
		{ SubType.AbilitesClick, "abilites_click" },
		{ SubType.EquipClick, "equip_click" },
		{ SubType.UnequipClick, "unequip_click" },
		{ SubType.ImbuePerk, "imbue_perk_click" },
		{ SubType.RemovePerk, "remove_perk_click" },
		{ SubType.InventorySlotChanged, "inventory_slot_changed" },
		{ SubType.ShopSlotChanged, "shop_slot_changed" },
		{ SubType.ShopSelectItem, "shop_select_item" },
		{ SubType.MapSelectBattle, "map_select_battle" },
		{ SubType.DialogClose, "dialog_close" },
		{ SubType.MenuOpen, "menu_open" }
	};
