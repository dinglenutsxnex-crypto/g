...
namespace SF3.GameModels
{
	...
	{
		public partial class CheckCollisionResult
		{
		...
		public bool CheckAttackCollisions()
		{
			...
			{
				List<IntervalAnimationPlayer> intervalExist = _modelState.GetIntervalExist(EIntervalsType.INTERVAL_ATTACK);
		...
		public bool CheckRepulsion()
		{
			...
			{
				IntervalExcludeRepulsion intervalExcludeRepulsion = (IntervalExcludeRepulsion)_modelState.modelAnimationPlayer.animationIntervals.Find((IntervalAnimationPlayer e) => e is IntervalExcludeRepulsion);
				...
				IntervalExcludeRepulsion intervalExcludeRepulsion2 = (IntervalExcludeRepulsion)_modelState.enemy.modelAnimationPlayer.animationIntervals.Find((IntervalAnimationPlayer e) => e is IntervalExcludeRepulsion);
