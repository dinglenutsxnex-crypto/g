	...
	public class Messenger
	{
		...
		private static void Message(string msg, StringWrapperPurpose purpose)
		{
			...
			case StringWrapperPurpose.Error:
				...
				break;
			default:
				GD.PrintErr(StringWrapper.Create(StringWrapperPurpose.Error, string.Format("The <{0}> type [{1}] is not supported by <{2}>", typeof(StringWrapperPurpose).Name, purpose.ToString(), typeof(Messenger).Name)).ToString());
