...
namespace SF3.Moves
{
	public partial class TriggerEventHit : TriggerEvent
	{
		private readonly string _animationName;
		private readonly AttributeType _defenseName;
		public TriggerEventHit(Mapping eventMap)
			: base(ETriggerEvents.EVENT_HIT, eventMap)
		{
			...
			if (eventMap != null)
			{
				...
				if (TryGetString(out outResult, "AnimationPlayer", string.Empty, string.Empty, null, false))
				{
		...
		public override bool Equal(BattleEventArgs args)
		{
			...
			if (_animationName.Length > 0 && args.EventData != null)
			{
				...
				string[] animationNames = strikeData.attackingModel.modelAnimationPlayer.animationNames;
