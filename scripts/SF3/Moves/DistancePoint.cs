...
{
	[Serializable]
	public partial class DistancePoint
	{
		...
		public Vector3 GetPosition(IAnimatedModel animatedModel)
		{
			...
			case EDistanceObject.OBJECT_BACK:
				...
				break;
			default:
				GD.PrintErr("ERROR: unknown object type: " + _distObject);
				break;
			}
			return result;
		}
		...
		protected Vector3 GetPositionFrame(Bone modelBone)
		{
			...
			default:
				GD.PrintErr("DistancePoint: getPositionFrame - unknown frame: " + _frame);
				return modelBone.position;
			}
		}
		...
		public static EDistanceObject GetDistanceObjectByName(string distanceObjectName)
		{
			...
			GD.PrintErr("Distance Object - parseType - unknownType: " + distanceObjectName);
