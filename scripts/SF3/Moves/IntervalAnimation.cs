...
namespace SF3.Moves
{
    ...
    public class IntervalAnimation
    {
        ...
        static IntervalAnimation()
        {
            ...
            {
                { "Uninterrupt", EIntervalsType.INTERVAL_UNINTERRUPT },
                { "SelfUninterrupt", EIntervalsType.INTERVAL_SELF_UNINTERRUPT },
                { "Attack", EIntervalsType.INTERVAL_ATTACK },
                { "NoRepulsion", EIntervalsType.INTERVAL_NO_REPULSION },
                { "NoWallRepulsion", EIntervalsType.INTERVAL_NO_WALL_REPULSION },
                { "Dodgeable", EIntervalsType.INTERVAL_DODGEABLE },
                { "Blockable", EIntervalsType.INTERVAL_BLOCKABLE },
                { "Slowmo", EIntervalsType.INTERVAL_SLOWMOTION },
                { "Invincible", EIntervalsType.INTERVAL_INVINCIBLE },
                { "Transitional", EIntervalsType.INTERVAL_TRANSITIONAL },
                { "DissolveWeapon", EIntervalsType.INTERVAL_DISSOLVE_WEAPON }
            };
        }
        ...
        public static List<IntervalAnimation> Create(Sequence intervalsNodes)
        {
            ...
            foreach (Mapping item in intervalsNodes.nodesInside)
            {
                ...
                if (list2.Count > 0)
                    ...
                    GD.PushWarning("IntervalAnimation is null");
            }
            return list;
        }
        ...
        public virtual List<IntervalAnimation> Parse(Mapping intervalNode)
        {
            ...
            return new List<IntervalAnimation> { this };
        }
    }
}
