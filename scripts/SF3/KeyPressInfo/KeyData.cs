...
namespace SF3.KeyPressInfo
{
	public struct KeyData
	{
		...
		{
			{ "Hold", KeyPressState.Hold },
			{ "Tap", KeyPressState.Down },
			{ "Release", KeyPressState.Up },
			{ "Down", KeyPressState.Down },
			{ "UnHold", KeyPressState.UnHold },
			{ "Unhold", KeyPressState.UnHold },
			{ "Up", KeyPressState.Up },
			{ "Any", KeyPressState.Any },
			{ "ANY", KeyPressState.Any },
			{ string.Empty, KeyPressState.Any }
		};

		private static Dictionary<string, EQuadrants> codeComplince = new Dictionary<string, EQuadrants>
		{
			{ "Up", EQuadrants.One },
			{ "Up_Forward", EQuadrants.Two },
			{ "Forward", EQuadrants.Three },
			{ "Down_Forward", EQuadrants.Four },
			{ "Down", EQuadrants.Five },
			{ "Down_Back", EQuadrants.Six },
			{ "Back", EQuadrants.Seven },
			{ "Up_Back", EQuadrants.Eight },
			{ "Punch", EQuadrants.Punch },
			{ "Kick", EQuadrants.Kick },
			{ "Missile", EQuadrants.Missile },
			{ "Shadow", EQuadrants.Magic },
			{ "TEST1", EQuadrants.TEST1 },
			{ "TEST2", EQuadrants.TEST2 },
			{ "Any", EQuadrants.Any },
			{ "ANY", EQuadrants.Any },
			{ "None", EQuadrants.None }
		};
		...
		public KeyData(EQuadrants battleCode, System.Collections.Generic.IEnumerable<string> pressStateNames)
		{
			this = default(KeyData);
		...
		public KeyData(string battleCodeName, System.Collections.Generic.IEnumerable<string> pressStateNames)
		{
			this = default(KeyData);
			battleCode = GetBattleCodeByName(battleCodeName);
			pressState = KeyPressState.Undefined;
