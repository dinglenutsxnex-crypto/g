...
using Godot;
using sf3DTO;
public partial class BoosterpackItem : ReelItem
{
	[Export]
	...
	[Export]
	private NekkiLabel _rewardStatusLbl;
	private void _Ready()
	{
		_Node3D = base.Node3D;
	...
	private void InitRarity(BaseItem baseItem)
	{
		...
		case Rarity.Legendary:
			...
			break;
		default:
			GD.PrintErr(string.Concat("No rarity found for boosterpack. Rarity key: [", rarityType, "]"));
			break;
		}
	}
