...
using SF3.Moves;
public partial class LoseAnimationsRule : FightRule
{
	...
	private void CheckAnimationStart(BattleEventArgs args)
	{
		...
		foreach (string AnimationPlayer in animations)
		{
			if (modelInfoAnimationPlayer.AnimationPlayer.name.Equals(AnimationPlayer))
			{
